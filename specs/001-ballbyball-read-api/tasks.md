...
- [x] T008 Implement Cosmos managed-identity client factory in `src/Cricsheet.Api/Infrastructure/Cosmos/`.
- [x] T009 Implement database provider abstraction wiring in `src/Cricsheet.Api/Infrastructure/Providers/`.
...
- [x] T011 [US1] Write integration tests for browse endpoint with filter combinations in `tests/Cricsheet.Api.IntegrationTests/BrowseEndpointTests.cs`.
...
- [x] T025 [US3] Ensure endpoints return structured frontend-consumable errors.
